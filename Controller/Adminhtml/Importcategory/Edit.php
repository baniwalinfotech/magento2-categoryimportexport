<?php
namespace Baniwal\Importexportcategory\Controller\Adminhtml\Importcategory;
...
class Edit extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Baniwal_Importexportcategory::importexportcategory');
    }
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Baniwal_Importexportcategory::importexportcategory');
